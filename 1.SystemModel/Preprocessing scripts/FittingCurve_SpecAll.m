...
%Script to find Parameter of the curve StaffGage vs HSI
%Created by Omar Alminagorta - 24March 2016
%Extended by David Rosenberg -29March2016 to better fit curves

%Reads suitable area versus water level results in WeightedHSIArea.xls (generated by
...
%     - Suitable area calcuations read in from WeightedHSIArea.xls for the three
...
%     - Suitable area calculated by prior method that assumes entire wetland unit is at the water level in dashed light blue
 %    - Suitable area read in from WeightedHSIArea.xls calculated
...
%The file 'WeightedHSIArea.xls' inclues staff gage vs depth varying
%suitable area for each wetland unit and species. The file also inclues
%suitable area for each species calculated using the prior method that
%assumes uniform water level in a wetland unit.
%
%% Start
...
for j=1:s %work each species
    ...
    for i=1:25;%input the 25 wetland units
        ...
        [data,text]= xlsread('WeightedHSIArea.xls', i);
