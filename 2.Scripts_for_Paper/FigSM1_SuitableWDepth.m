...
% Redude fonts x-y axes, save and adjust legend
%
%% Start
...
%        SuitableArea=(data(:,1+j))*0.01;%Suitable Area in Km- for species
        ...
        set(gca,'yLim',[0 yLimCurr(2)],'Fontsize',12);
         ...
         if i==23,xlabel('Staff gage reading (m)','fontsize',16,'FontName','Times New Roman'); end
         if i==11,ylabel('Area (Ha)','fontsize',16,'FontName','Times New Roman');end 
...
%  hleg =  legend({'Wetted area (LIDAR)' SpecNamesLeg{:}},'FontSize',14);   
%   set(lng,'Position',[0.7499 0.7753 0.2523 0.1944]);
hleg = legend({'Wetted area (LIDAR)' SpecNamesLeg{:}});
%Editing legend
set(hleg,'Orientation','horizontal',...
    'Position',[0.0883217508055853 0.0042650676506767 0.834317937701396 0.0341328413284133],...
    'FontSize',8,...
